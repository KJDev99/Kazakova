...
export default function PrivacyContent() {
  return (
    <div className="grid grid-cols-3 px-22 max-w-[1920px] mx-auto">
      <div className="col-span-2">
        <h2 className="mb-4 font-medium text-[32px]">1. Общие положения</h2>
        <p>
        ...
        <h2 className="mb-4 font-medium mt-10 text-[32px]">
        ...
        <p>12.8.3 Покинуть сайт во избежание дальнейшей обработки cookies.</p>
        <p>
        ...
        <p>12.9.2 Названия и значения параметров, хранящихся в cookies.</p>
        <p>12.9.3 Сроки действия cookies.</p>
        <h2 className="mb-4 font-medium mt-10 text-[32px]">
