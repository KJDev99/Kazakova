...
export default function PrivacyContent() {
  return (
    <div className="md:grid md:grid-cols-3 px-22 max-w-[1920px] mx-auto max-md:px-4">
      <div className="md:col-span-2">
        <h2 className="mb-4 font-medium text-[32px] max-md:text-lg">
          1. Общие положения
        </h2>
        <p className="text-sm">
          ...
          безопасности персональных данных, предпринимаемые ________ (далее —
          Оператор).
        </p>
        <p className="text-sm">
        ...
        <h2 className="mb-4 font-medium mt-10 text-[32px] max-md:text-lg">
        ...
        <p className="text-sm">
          ...
          сети интернет по сетевому адресу _______________________.
        </p>
        <p className="text-sm">
        ...
        <p className="text-sm">3.1. Оператор имеет право:</p>
        <p className="text-sm">
        ...
        <p className="text-sm">3.2. Оператор обязан:</p>
        <p className="text-sm">
        ...
        <p className="text-sm">4.2. Субъекты персональных данных обязаны:</p>
        <p className="text-sm">
        ...
        <p className="text-sm">
          ...
          info@hot-walls.ru с пометкой «Актуализация персональных данных».
        </p>
        <p className="text-sm">
          ...
          на электронный адрес Оператора info@hot-walls.ru с пометкой «Отзыв
        ...
        <h2 className="mb-4 font-medium mt-10 text-[32px] max-md:text-lg">
          11. Обработка электронных пользовательских данных, включая cookies
        </h2>
        <p className="text-sm">
          12.1 Оператор в целях обработки персональных данных, установленных
          Политикой, может собирать электронные пользовательские данные на своих
          сайтах автоматически, без необходимости участия пользователя и
          совершения им каких-либо действий по отправке данных.
        </p>
        <p className="text-sm">
          12.2 Достоверность собранных таким способом электронных данных в
          Оператор не проверяется, информация обрабатываются «как есть» в том
          виде, как она поступила с клиентского устройства.
        </p>
        <p className="text-sm">
          12.3 Пользователям могут показываться всплывающие уведомления о сборе
          и обработке данных cookies со ссылкой на Политику и кнопками принятия
          условий обработки либо закрытия всплывающего уведомления.
        </p>
        <p className="text-sm">
          12.4 Такие уведомления означают, что при посещении и использовании
          Веб-сайта в браузер на устройстве пользователя может сохраняться
          информация (например, данные cookies), позволяющая в дальнейшем
          идентифицировать пользователя или устройство, запомнить сеанс работы
          или сохранить некоторые настройки и предпочтения пользователя,
          специфичные для этих конкретных сайтов. Такая информация после
          сохранения в браузер и до истечения установленного срока действия или
          удаления с устройства будет отправляться при каждом последующем
          запросе на сайт, от имени которого они были сохранены, вместе с этим
          запросом для обработки на стороне Оператор.
        </p>
        <p className="text-sm">
          12.5 Обработка данных cookies необходима Оператору для корректной
          работы сайтов, в частности, их функций, относящихся к доступу
          зарегистрированных пользователей программных продуктов, услуг, работ и
          ресурсов Оператора; персонализации пользователей; повышения
          эффективности и удобства работы с сайтами, а также иных целей,
          предусмотренных Политикой.
        </p>
        <p className="text-sm">
          12.6 Кроме обработки данных cookies, установленных самими сайтами
          Оператор, пользователям и посетителям могут устанавливаться cookies,
          относящиеся к сайтам сторонних организаций, например, в случаях, когда
          на сайтах Оператор используются сторонние компоненты и программное
          обеспечение. Обработка таких cookies регулируется политиками
          соответствующих сайтов, к которым они относятся, и может изменяться
          без уведомления пользователей сайтов Оператор. К таким случаям может
          относиться размещение на сайтах:
        </p>
        <p className="text-sm">
          12.6.1 Счетчиков посещений, аналитических и статистических сервисов,
          таких как Яндекс.Метрика или Google Analytics для сбора статистики
          посещаемости общедоступных страниц сайтов.
        </p>
        <p className="text-sm">
          12.6.2 Виджетов вспомогательных сервисов для сбора обратной связи,
          организации чатов и иных видов коммуникаций с пользователями.
        </p>
        <p className="text-sm">
          12.6.3 Систем контекстной рекламы, баннерных и иных маркетинговых
          сетей
        </p>
        <p className="text-sm">
          12.6.4 Кнопок авторизации на сайтах с помощью учетных записей в
          социальных сетях.
        </p>
        <p className="text-sm">
          12.6.5 Иных сторонних компонент, используемых Оператор на своих
          сайтах.
        </p>
        <p className="text-sm">
          12.7 Принятие пользователем условий обработки cookies или закрытие
          всплывающего уведомления в соответствии с Политикой расценивается как
          согласие на обработку данных cookies на Веб-сайте.
        </p>
        <p className="text-sm">
          12.8 В случае если пользователь не согласен с обработкой cookies, он
          должен принять на себя риск, что в таком случае функции и возможности
          сайта могут не быть доступны в полном объеме, а затем следовать по
          одному из следующих вариантов:
        </p>
        <p className="text-sm">
          2.8.1 Произвести самостоятельную настройку своего браузера в
          соответствии с документацией или справкой к нему таким образом, чтобы
          он на постоянной основе не разрешал принимать и отправлять данные
          cookies для любых сайтов либо для конкретного сайта Оператора или
          сайта стороннего компонента.
        </p>
        <p className="text-sm">
          12.8.2 Переключиться в специальный режим «инкогнито» браузера для
          использования сайтом cookies до закрытия окна браузера или до
          переключения обратно в обычный режим.
        </p>
        <p className="text-sm">
          12.8.3 Покинуть сайт во избежание дальнейшей обработки cookies.
        </p>
        <p className="text-sm">
          12.9 Пользователь может самостоятельно через встроенные в браузеры
          средства работы с данными cookies управлять сохраненными данными, в
          том числе, удалять или просматривать сведения об установленных сайтами
          cookies, включая:
        </p>
        <p className="text-sm">
          12.9.1 Адреса сайтов и пути на них, куда будут отправляться cookies.
        </p>
        <p className="text-sm">
          12.9.2 Названия и значения параметров, хранящихся в cookies.
        </p>
        <p className="text-sm">12.9.3 Сроки действия cookies.</p>
        <h2 className="mb-4 font-medium mt-10 text-[32px] max-md:text-lg">
        ...
        <p className="text-sm">
          ...
          Оператору с помощью электронной почты info@hot-walls.ru.
        </p>
        <p className="text-sm">
